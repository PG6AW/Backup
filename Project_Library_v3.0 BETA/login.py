# The initiative piece of the project, the first file that opens up in order for users to login and use the project
        ...
        try:
            if i == str(password):
                ...
                if confirm:
                    ...
                    if open_it:
                        subprocess.Popen(['python', 'MAINFILE__Book_Library.py']) #You can modify the address to which user will be redirected!
