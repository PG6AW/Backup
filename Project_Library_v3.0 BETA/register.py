# A Register tool to sign up and open an account
...
messagebox.showinfo("Welcome!", "Welcome! We're absolutely as proud as You, as you are now using this project!\n\nMake good use of it and have a good moment joining us while at the same time registering an account for yourself!")
